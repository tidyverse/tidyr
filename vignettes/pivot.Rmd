...
`pivot_long()` makes datasets __longer__ by reducing the number of columns and increasing the number of rows. `pivot_long()` is commonly needed to tidy wild-caught datasets as they often optimised for ease of data entry or ease of comparison rather than ease of analysis. 
