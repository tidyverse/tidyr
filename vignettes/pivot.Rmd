...
Sometimes getting a dataset into the needed form requires multiple pivots. The final three case studies show a few examples that require substantial work to get into a useful format.
