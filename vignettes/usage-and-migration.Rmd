...
First, lets create an example to make the problem concrete:
...
`nest_()` and `unnest_()` no longer work as we gradually remove support for the old lazyeval framework in favour of the more powerful tidy eval.
