...
- **Tidy selection**:
  ...
  [`fill()`](https://tidyr.tidyverse.org/reference/fill.md),
  [`pivot_longer()`](https://tidyr.tidyverse.org/reference/pivot_longer.md)/[`pivot_wider()`](https://tidyr.tidyverse.org/reference/pivot_wider.md),
  [`nest()`](https://tidyr.tidyverse.org/reference/nest.md)/[`unnest()`](https://tidyr.tidyverse.org/reference/unnest.md),
  [`separate()`](https://tidyr.tidyverse.org/reference/separate.md)/[`extract()`](https://tidyr.tidyverse.org/reference/extract.md),
  and [`unite()`](https://tidyr.tidyverse.org/reference/unite.md) let
  you select variables based on position, name, or type (e.g. `1:3`,
...
- **Data masking**:
  ...
  [`nesting()`](https://tidyr.tidyverse.org/reference/expand.md) let you
  refer to use data variables as if they were variables in the
...
[`?tidyr_tidy_select`](https://tidyr.tidyverse.org/reference/tidyr_tidy_select.md).
