...
- It describes migration patterns for the transition from tidyr v0.8.3
  ...
  [`unnest()`](https://tidyr.tidyverse.org/reference/unnest.md) in order
  to increase consistency within tidyr and with the rest of the
  tidyverse.
...
[`nest()`](https://tidyr.tidyverse.org/reference/nest.md) is looking for
the variables inside of `mini_iris` (i.e. `Petal.Length` and friends are
data-variables, not env-variables).
...
[`nest()`](https://tidyr.tidyverse.org/reference/nest.md) and
[`unnest()`](https://tidyr.tidyverse.org/reference/unnest.md) in order
to bring them in line with newer tidyverse conventions. I have tried to
make the functions as backward compatible as possible and to give
informative warning messages, but I could not cover 100% of use cases,
so you may need to change your package code. This guide will help you do
so with a minimum of pain.
...
- [`nest()`](https://tidyr.tidyverse.org/reference/nest.md) and
  [`unnest()`](https://tidyr.tidyverse.org/reference/unnest.md) get new
  interfaces.
- [`nest()`](https://tidyr.tidyverse.org/reference/nest.md) preserves
  groups.
- [`nest_()`](https://tidyr.tidyverse.org/reference/deprecated-se.md)
  and
  [`unnest_()`](https://tidyr.tidyverse.org/reference/deprecated-se.md)
  are defunct.
...
instead of [`nest()`](https://tidyr.tidyverse.org/reference/nest.md).
It’s the same as
[`nest()`](https://tidyr.tidyverse.org/reference/nest.md) in v0.8.3:
...
instead of
[`unnest()`](https://tidyr.tidyverse.org/reference/unnest.md). It’s the
same as [`unnest()`](https://tidyr.tidyverse.org/reference/unnest.md) in
v0.8.3:
...
If the fact that
[`nest()`](https://tidyr.tidyverse.org/reference/nest.md) now preserves
groups is problematic downstream, you have a few choices:
