...
- [`hoist()`](https://tidyr.tidyverse.org/reference/hoist.md) is similar
  to
  [`unnest_wider()`](https://tidyr.tidyverse.org/reference/unnest_wider.md)
...
[`hoist()`](https://tidyr.tidyverse.org/reference/hoist.md) allows us to
pull out selected components using the same syntax as
...
[`hoist()`](https://tidyr.tidyverse.org/reference/hoist.md) removes the
named components from the `user` list-column, so you can think of it as
moving components out of the inner list into the top-level data frame.
...
Then we can use
[`unnest_wider()`](https://tidyr.tidyverse.org/reference/unnest_wider.md)
or [`hoist()`](https://tidyr.tidyverse.org/reference/hoist.md):
...
Or use [`hoist()`](https://tidyr.tidyverse.org/reference/hoist.md) to
dive deeply to get directly to `lat` and `lng`:
