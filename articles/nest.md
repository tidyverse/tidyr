...
[`tidyr::nest()`](https://tidyr.tidyverse.org/reference/nest.md):
...
[`nest()`](https://tidyr.tidyverse.org/reference/nest.md) specifies
...
[`unnest()`](https://tidyr.tidyverse.org/reference/unnest.md). You give
it the name of a list-column containing data frames, and it row-binds
the data frames together, repeating the outer columns the right number
of times to line up.
...
[`unnest()`](https://tidyr.tidyverse.org/reference/unnest.md)ed to get
back to flat data frames. You can see a bigger example in the [broom and
dplyr
