...
- names_repair:
  ...
  - [tidyr_legacy](https://tidyr.tidyverse.org/reference/tidyr_legacy.md):
...
[`nest()`](https://tidyr.tidyverse.org/reference/nest.md) and `unnest()`
that's designed to be more similar to other functions. Converting to the
new syntax should be straightforward (guided by the message you'll
receive) but if you just need to run an old analysis, you can easily
revert to the previous behaviour using
