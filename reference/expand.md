...
- ...:
  ...
  \<[`data-masking`](https://tidyr.tidyverse.org/reference/tidyr_data_masking.md)\>
  ...
  [`complete()`](https://tidyr.tidyverse.org/reference/complete.md) use
  the full set of levels, not just those that appear in the data. If you
...
[`complete()`](https://tidyr.tidyverse.org/reference/complete.md) to
expand list objects.
[`expand_grid()`](https://tidyr.tidyverse.org/reference/expand_grid.md)
