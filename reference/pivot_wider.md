...
- id_expand:
  ...
  [`expand()`](https://tidyr.tidyverse.org/reference/expand.md) before
...
[`spread()`](https://tidyr.tidyverse.org/reference/spread.md), designed
to be both simpler to use and to handle more use cases. We recommend you
use `pivot_wider()` for new code;
[`spread()`](https://tidyr.tidyverse.org/reference/spread.md) isn't
